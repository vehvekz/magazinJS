...
$email = $_POST['email'];
$total = $_POST['total'];
$smstext = "Заказ орехи от ".$name." email: ".$email." сум: ".$total;
$goods = $_POST['goods'];
$tr = '';
...
$subject = 'Заявка на грибы';

$message = '
	<html>
		<head>
			<title>Заявка на грибы</title>
			<style>
		     td, th{
...
if($mail)
{
	...
	$user = 'savkinshot@gmail.com';            // логин указанный при регистрации или логин api-аккаунта http://littlesms.ru/my/settings/api
	...
	// отправка СМС
	$ids = $api->messageSend('79374432572', $smstext);
	// if ($ids) {
